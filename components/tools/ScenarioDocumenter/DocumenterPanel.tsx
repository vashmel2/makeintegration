...
import { FileText, ChevronDown, ChevronUp, AlertCircle, Upload } from "lucide-react"
import { parseScenario, scenarioToMarkdown, EXAMPLE_BLUEPRINT } from "./parser"
import { DocumentView } from "./DocumentView"
import type { ParsedScenario } from "./types"

type PanelState = "idle" | "done" | "error"

export function DocumenterPanel() {
  ...
  const handleGenerate = () => parse(raw)

  const handleLoadExample = () => {
    setRaw(EXAMPLE_BLUEPRINT)
    parse(EXAMPLE_BLUEPRINT)
  }
        ...
        {tipOpen && (
          <div className="border-t border-border px-4 pb-4 pt-3">
            <ol className="space-y-2 text-sm text-muted-foreground list-decimal list-inside">
              ...
              <li>
                Click the <strong className="text-foreground">three dots (...)</strong> menu in the
                bottom toolbar
              </li>
              <li>
                Select <strong className="text-foreground">Export Blueprint</strong>
              </li>
